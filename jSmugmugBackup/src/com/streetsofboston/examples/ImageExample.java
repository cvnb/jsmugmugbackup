package com.streetsofboston.examples;
...
public class ImageExample {
	...
	public static final String MY_ACCOUNT_EMAIL = "<email>";
	...
	public void execImageExamples() throws SmugmugException, IOException {
		final InputStream is1 = getClass().getClassLoader().getResourceAsStream("img1.jpg");
		final InputStream is2 = getClass().getClassLoader().getResourceAsStream("img2.jpg");
