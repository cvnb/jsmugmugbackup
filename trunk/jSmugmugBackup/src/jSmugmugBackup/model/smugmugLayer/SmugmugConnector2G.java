...
//
//
//public class SmugmugConnector2G implements ISmugmugConnector
//{
...
//            SmugmugConnector2G.login_nickname = userEmail;
//            return 0;
//        }
//        else
//        {
...
//	public void logout()
//	{
//		if (SmugmugConnector2G.login_sessionID != null) { this.smugmug_logout_logout(); }
//		else
//		{
//			//just to be sure
//        	SmugmugConnector2G.login_sessionID    = null;
//        	SmugmugConnector2G.login_userID       = null;
//        	SmugmugConnector2G.login_nickname     = null;
//        	SmugmugConnector2G.login_passwordHash = null;
//		}
//	}
//	public IRootElement getTree()
//	{
//        if (SmugmugConnector2G.login_sessionID == null) { return null; }
//
//
...
//
//
//        SmugmugConnector2G.albumCache = null;
//        if (this.config.getPersistentCacheAccountInfo())
//        {
//            if (this.config.getRtconfigAnonymousLogin() == false)
//            {
//                SmugmugConnector2G.albumCache = new SmugmugLocalAlbumCache(SmugmugConnector2G.login_userID.toString());
//            }
//            else
//            {
//                SmugmugConnector2G.albumCache = new SmugmugLocalAlbumCache(SmugmugConnector2G.login_nickname);
//            }
//            SmugmugConnector2G.albumCache.loadCacheFromDisk();
//        }
//
//		IRootElement smugmugRoot = new RootElement(SmugmugConnector2G.login_nickname);
//
...
//                    if (this.config.getPersistentCacheAccountInfo())
//                    {
//                        SmugmugConnector2G.albumCache.validateCachedAlbum(albumID.intValue(), albumImageCount.intValue(), albumLastUpdated, albumName);
//                    }
//
//                    statAlbumIndex++;
...
//                    if (this.config.getPersistentCacheAccountInfo())
//                    {
//                        if (SmugmugConnector2G.albumCache.exists(albumID.intValue()))
//                        {
//                            album = new Album(subcategory, SmugmugConnector2G.albumCache.getCachedAlbum(albumID.intValue()), this.getAlbumStatistics(albumID.intValue()));
...
//                        if (this.config.getPersistentCacheAccountInfo())
//                        {
//                            SmugmugConnector2G.albumCache.putAlbum(album);
//                            SmugmugConnector2G.albumCache.saveCacheToDisk(); //this might produce quite some I/O overhead, but allows resuming of account info downloads
//                        }
//                    }
//
//					albumIndex++;
...
//                    if (SmugmugConnector2G.albumCache.exists(albumID.intValue()))
//                    {
//                        album = new Album(category, SmugmugConnector2G.albumCache.getCachedAlbum(albumID.intValue()), this.getAlbumStatistics(albumID.intValue()));
...
//
//        if (this.config.getPersistentCacheAccountInfo()) { SmugmugConnector2G.albumCache.saveCacheToDisk(); }
//
...
//	        {
//	        	SmugmugConnector2G.login_sessionID    = (String)this.getJSONValue(jobj, "Login.Session.id");
//	        	SmugmugConnector2G.login_userID       = (Number)this.getJSONValue(jobj, "Login.User.id");
//	        	SmugmugConnector2G.login_nickname     = (String)this.getJSONValue(jobj, "Login.User.NickName");
//	        	SmugmugConnector2G.login_passwordHash = (String)this.getJSONValue(jobj, "Login.PasswordHash");
//	        	this.log.printLogLine("ok");
//	        	//return true;
//	        	return SmugmugConnector2G.login_userID;
//	        }
...
//	        	SmugmugConnector2G.login_sessionID    = (String)this.getJSONValue(jobj, "Login.Session.id");
//	        	SmugmugConnector2G.login_userID       = (Number)this.getJSONValue(jobj, "Login.User.id");
//	        	SmugmugConnector2G.login_nickname     = (String)this.getJSONValue(jobj, "Login.Session.NickName");
//	        	SmugmugConnector2G.login_passwordHash = (String)this.getJSONValue(jobj, "Login.PasswordHash");
...
//		url = url + "PasswordHash=" + SmugmugConnector2G.login_passwordHash + "&";
//
//
//		do
//		{
...
//            if (SmugmugConnector2G.albumCache == null) { this.log.printLogLine("ERROR: album cache has not been initialized"); System.exit(1); }
//
//            if (SmugmugConnector2G.albumCache.exists(albumID))
//            {
//                SmugmugConnector2G.albumCache.removeAlbum(albumID);
//                //this.log.printLogLine(Helper.getCurrentTimeString() + " removed album (id=" + albumID + ") from cache");
//
//                SmugmugConnector2G.albumCache.saveCacheToDisk();
//            }
//
//        }
//    }
